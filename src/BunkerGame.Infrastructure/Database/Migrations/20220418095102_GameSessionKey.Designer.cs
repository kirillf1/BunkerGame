...
namespace BunkerGame.Infrastructure.Migrations
{
    ...
    [Migration("20220418095102_GameSessionKey")]
    partial class GameSessionKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BunkerGame.Domain.GameSessions.GameSession", b =>
                {
                    b.HasOne("BunkerGame.Domain.Bunkers.Bunker", "Bunker")
                        .WithOne()
                        .HasForeignKey("BunkerGame.Domain.GameSessions.GameSession", "BunkerId")
                        .OnDelete(DeleteBehavior.Cascade);
